...
<body>
  ...
  <nav class="navbar navbar-inverse navbar-expand-lg navbar-dark sss-black text-uppercase ">
 <!--    <div class="container-fluid">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="p-4 col-md-6 text-md-left text-center">
          ...
          <p>
            <i class="fas d-inline mr-1 sss-text-gray fa-phone"></i><a href="tel:+1019876 543 21 00" class="text-white"><!-- <i class="fas d-inline mr-1 sss-text-gray fa-phone"></i> -->+1019876 543 21 00</a>
          </p>
          <p>
            <i class="fas d-inline mr-1 sss-text-gray fa-address-card"></i><a href="mailto:sales@king-day.com" class="text-white"><!-- <i class="fas d-inline mr-1 sss-text-gray fa-address-card"></i> -->sales@king-day.com</a>
          </p>
          <p>
            <i class="fas d-inline mr-1 fa-map-marker sss-text-gray"></i><a href="https://goo.gl/maps/AUq7b9W7yYJ2" class="text-white" target="_blank"><!-- <i class="fas d-inline mr-1 fa-map-marker sss-text-gray"></i> -->365 Park Street, NY</a>
          </p>
        </div>
      </div>
      <!-- <div class="row">
...
<!--       <a class="navbar-brand" href="#">Always expand</a>
      ...
      <div class="collapse navbar-collapse" id="footerNavbar">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#"><i class="fas fa-info-circle"></i>Help Center<span class="sr-only">(current)</span></a>
          </li>
        </ul>
