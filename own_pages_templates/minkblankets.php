...
<body>
 ...
 <!--    <div class="container-fluid">
    ...
    <div class="container">
      <a class="navbar-brand" href="#"><img src="img/kingday2.png"></a>
      ...
      <div class="collapse navbar-collapse align-self-end" id="headNavbar">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="#">Mink Blankets<span class="sr-only">(current)</span></a>
          </li>
          <li class="d-none d-lg-block">
            <span class="divider-vertical"></span>
          </li>
...
<section id="middlePage" class="bg-white my-5">
  ...
  <div class="secMinkblankets container d-flex align-items-center">
    <div class="container-fluid">
      <h1 class="text-uppercase">Favourite Designs</h1>

<!--       <div class="d-flex flex-row itemcontrol text-uppercase sss-hul">
        <div class="px-5"><a href="#" class="">All</a></div>
        <div class="px-5"><a href="#" class="">Mink Blankets</a></div>
        <div class="px-5"><a href="#" class="">Prayer Mats</a></div>
        <div class="px-5"><a href="#" class="">Flannel</a></div>
        <div class="px-5"><a href="#" class="">Carpets</a></div>
      </div> -->

<!--       <ul class="list-inline text-uppercase">
        <li class="list-inline-item px-5"><a href="#" class="sss-hul-item">All</a></li>
        <li class="list-inline-item px-5"><a href="#" class="sss-hul-item">Mink Blankets</a></li>
        <li class="list-inline-item px-5"><a href="#" class="sss-hul-item">Prayer Mats</a></li>
        <li class="list-inline-item px-5"><a href="#" class="sss-hul-item">Flannel</a></li>
       <li class="list-inline-item px-5 sss-hul-item"><a href="#" class="sss-hul-item">Carpets</a></li>
      </ul> -->

      <ul class="nav nav-pills text-uppercase text-secondary justify-content-center">
        <li class="nav-item px-4">
          <a class="nav-link" href="#">All</a>
        </li>
        <li class="nav-item px-4">
          <a class="nav-link active" href="#">Mink Blankets</a>
        </li>
        <li class="nav-item px-4">
          <a class="nav-link" href="#">Prayer Mats</a>
        </li>
      ...
      <div class="row my-4">
        <div class="col">
          <div class="card">
            <img class="card-img-top" src="http://via.placeholder.com/300x200" alt="Card image">
            <div class="card-body">
              <h4 class="card-title">FLW00132</h4>
<!--               <p class="card-text">Some example text.</p>
        ...
        <div class="col">
          <div class="card">
            <img class="card-img-top" src="http://via.placeholder.com/300x200" alt="Card image">
            <div class="card-body">
              <h4 class="card-title">FLW00100</h4>
<!--               <p class="card-text">Some example text.</p>
              <a href="#" class="btn btn-primary">See Profile</a> -->
            </div>
          </div>
        ...
        <div class="col">
          <div class="card">
            <img class="card-img-top" src="http://via.placeholder.com/300x200" alt="Card image">
            <div class="card-body">
              <h4 class="card-title">FLW00288</h4>
<!--               <p class="card-text">Some example text.</p>
              <a href="#" class="btn btn-primary">See Profile</a> -->
            </div>
          </div>
