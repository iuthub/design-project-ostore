      ...
      <div class="row my-4 text-center">
        <div class="col">
          <div class="card border-0">
            <img class="card-img-top" src="http://via.placeholder.com/200x300" alt="Card image">
            <div class="card-body">
              <h4 class="card-title">Mink Blankets</h4>
<!--               <p class="card-text">Some example text.</p>
        ...
        <div class="col">
          <div class="card border-0">
            <img class="card-img-top" src="http://via.placeholder.com/200x300" alt="Card image">
            <div class="card-body">
              <h4 class="card-title">Prayer Mats</h4>
<!--               <p class="card-text">Some example text.</p>
              <a href="#" class="btn btn-primary">See Profile</a> -->
            </div>
          </div>
        ...
        <div class="col">
          <div class="card border-0">
            <img class="card-img-top" src="http://via.placeholder.com/200x300" alt="Card image">
            <div class="card-body">
              <h4 class="card-title">Flannel</h4>
<!--               <p class="card-text">Some example text.</p>
              <a href="#" class="btn btn-primary">See Profile</a> -->
            </div>
          </div>
        ...
        <div class="col">
          <div class="card border-0">
            <img class="card-img-top" src="http://via.placeholder.com/200x300" alt="Card image">
            <div class="card-body">
              <h4 class="card-title">Carpets</h4>
<!--               <p class="card-text">Some example text.</p>
              <a href="#" class="btn btn-primary">See Profile</a> -->
            </div>
          </div>
