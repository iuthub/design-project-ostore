...
<section id="middlePage" class="bg-white my-5">
  ...
  <div class="secOrders container d-flex align-items-center">
    <div class="container-fluid">
      <h1 class="text-uppercase sss-text-black">Orders</h1>
      <table class="table table-striped border-bottom">
        ...
        <tbody>
          <tr>
            <th scope="row" class="text-center"><i class="fas fa-check-circle text-success"></i></th>
            <td>#7654324</td>
            <td>Jiangsu bla bla</td>
            <td class="text-center"><i class="fas fa-file"></i></td>
            <td class="text-center">Otto</td>
            <td class="text-center"><i class="fas fa-eye"></i></td>
          </tr>
          <tr>
            <th scope="row" class="text-center"><i class="fas fa-ellipsis-h"></i></th>
            <td>#7215324</td>
            <td>Thornton</td>
            <td class="text-center"><i class="fas fa-file"></i></td>
            <td class="text-center">Otto</td>
          ...
          <tr>
            <th scope="row" class="text-center"><i class="fas fa-times-circle text-danger"></i></th>
            <td>#3356624</td>
            <td>the Bird</td>
            <td class="text-center"><i class="fas fa-file"></i></td>
            <td class="text-center">Otto</td>
