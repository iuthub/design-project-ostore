...
<section id="middlePage" class="bg-white my-5">
  ...
  <div class="secOrders container d-flex align-items-center">
    <div class="container-fluid">
      <h1 class="text-uppercase sss-text-black">Order<i class="fas fa-check-circle text-success"></i></h1>
      <h3 class="text-uppercase">#7654324</h3>
      <table class="table table-striped border-bottom">
        ...
        <tbody>
          <tr>
            <th scope="row"><img src="http://via.placeholder.com/200x200" alt="..." class="img-fluid"></th>
            <td>ASL00191-RED</td>
            <td>Please add other bright colors...</td>
            <td class="text-center">
              <div class="row justify-content-center"><!-- Amount right-->
                <div class="input-group number-spinner col-lg-8 col-md-12 col-sm-6 col-xs-6">
