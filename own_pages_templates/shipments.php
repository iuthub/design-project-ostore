...
<section id="middlePage" class="bg-white my-5">
  ...
  <div class="secShipment container d-flex align-items-center">
    <div class="container-fluid">
      <div class="row">
        <div class="col">
          <h1 class="text-uppercase sss-text-black">Arkyn</h1>
          <h3 class="text-uppercase">Welcome to your account page</h3>
          <div class="list-group">
            <a href="index.php"><button type"button" class="btn btn-dark sss-black rounded-0 text-uppercase px-4">New Order<i class="fas fa-chevron-circle-right ml-2"></i></button></a>
            <a href="index.php"><button type"button" class="btn btn-dark sss-black rounded-0 text-uppercase px-4">Favourite Designs<i class="fas fa-chevron-circle-right ml-2"></i></button></a>
            <a href="index.php"><button type"button" class="btn btn-dark sss-black rounded-0 text-uppercase px-4">Orders<i class="fas fa-chevron-circle-right ml-2"></i></button></a>
            <a href="index.php"><button type"button" class="btn btn-dark sss-black rounded-0 text-uppercase px-4">Shipments<i class="fas fa-chevron-circle-right ml-2"></i></button></a>
            <a href="index.php"><button type"button" class="btn btn-dark sss-black rounded-0 text-uppercase px-4">Edit Account<i class="fas fa-chevron-circle-right ml-2"></i></button></a>
            <a href="#" class="list-group-item list-group-item-action px-0 border-0 rounded-0">Log Out</a>
          </div>
        </div>
        <div class="col">
          <img src="http://via.placeholder.com/1000x800" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
