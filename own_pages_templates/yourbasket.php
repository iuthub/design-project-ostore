...
<section id="middlePage" class="bg-white my-5">
  ...
  <div class="container d-flex align-items-center">
        ...
        <div class="col-8"><!-- YOUR BASKET LEFT-->
          ...
          <div class="row py-4 border-bottom mr-4"> <!-- PRODUCT 1-->
            <div class="col-4"><!-- Product image LEFT-->
              <img src="http://via.placeholder.com/200x200" alt="..." class="img-fluid"> 
            </div>
            <div class="col-8"><!-- Details RIGHT-->
              <div class="row">
                <div class="col-lg-8"><!-- Info left-->
                  <h5 class="text-uppercase font-weight-bold" id="itemname">ASL00181</h5>
    ...
    <!--                 <div class="d-flex flex-row itemcontrol input-group number-spinner justify-content-center">
                      <div class="p-0">                    <span class="input-group-btn">
                        <button class="btn btn-default rounded-0" data-dir="dwn"><i class="fas fa-minus"></i></button>
                      </span></div>
                      <div class="p-0"><input type="text" class="form-control text-center" value="1"></div>
                      <div class="p-0"><span class="input-group-btn">
                        <button class="btn btn-default rounded-0" data-dir="up"><i class="fas fa-plus"></i></button>
                      </span></div>
                    </div> -->
              ...
              <div class="d-flex flex-row itemcontrol"><!-- Control -->
                ...
                <div class="pr-2"><a href="#" class="">Delete</a></div>
                <div class="pr-2"><a href="#" class="">This is in favourites</a></div>
              </div>
            </div>
          </div>
    ...
    <!--                 <div class="d-flex flex-row itemcontrol input-group number-spinner justify-content-center">
          ...
          <div class="row pt-4 mr-4">
            <a href="index.php" class="w-100"><button type"button" class="btn btn-primary rounded-0 text-uppercase w-100">Proceed</button></a>
          </div>
        ...
        <div class="col-4 sss-lgray"><!-- PROCEED RIGHT-->
          <div class="list-group m-4">
            <a href="index.php"><button type"button" class="btn btn-primary rounded-0 text-uppercase mb-3 w-100">Proceed</button></a>
...
<script src="numbspinner.js"></script>
