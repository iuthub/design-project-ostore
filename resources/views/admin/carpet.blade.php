            ...
            <div class="col-sm-12 col-md-7 col-lg-8 col-xl-9">
                <div class="container d-flex align-items-center">
                    {{--//<form class="container">--}}
                        {!! Form::open(['method'=>'POST', 'action'=>'CarpetController@store', 'files'=>true ,'class'=>'container']) !!}
                        <h1>Upload</h1>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('category','Carpet',['class'=>'form-control text-uppercase rounded-0','disabled'=>true,'id'=>'productCode']) !!}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <button type="submit" class="btn btn-primary rounded-0 text-uppercase px-4 py-2">Create Carpet<i class="fas fa-chevron-circle-right ml-2"></i></button>
                            </div>
                        </div>
                        <!--
