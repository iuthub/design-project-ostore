                                ...
                                <div class="row my-4">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            @foreach($carpet->photos as $photo)
                                                <img class="card-img-top" src="{{ asset('storage/carpet/'.$photo->path) }}" alt="{{$photo->path}}">

                                            @endforeach
                                            <div class="card-body">
                                                <h4 class="card-title">{{$carpet->title}}</h4>
