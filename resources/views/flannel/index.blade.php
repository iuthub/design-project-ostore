                                ...
                                <div class="row my-4">
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            ...
                                            @foreach($flannel->photos as $photo)
                                                <img class="card-img-top" src="{{ asset('storage/flannel/'.$photo->path) }}" alt="{{$photo->path}}">

                                            @endforeach
                                            <div class="card-body">
                                                <h4 class="card-title">{{$flannel->title}}</h4>
